...
namespace SpaceBattle.Lib
{
    public static class IoC
    {
        ...
        public static void Register(string key, Func<object[], object> strategy) => _strategies[key] = strategy;

        public static T Resolve<T>(string key, params object[] args)
        {
            if (_strategies.TryGetValue(key, out var strategy)) return (T)strategy(args);
